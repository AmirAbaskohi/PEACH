...
flags.DEFINE_integer("dataset_skip", 0,
                     "Set number of examples for tfds to be skip")
flags.DEFINE_integer("current_train_steps", 0,
                     "Set number of examples for tfds to be skip")
  ...
  for train_steps in train_steps_list:
    estimator.train(
        input_fn=infeed.get_input_fn(
            ...
            dataset_skip=FLAGS.dataset_skip,
            current_train_steps=FLAGS.current_train_steps),
