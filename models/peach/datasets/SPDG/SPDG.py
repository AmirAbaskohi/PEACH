...
class SPDG(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_inputs = ['/*address to inputs.txt file in multlilingual model output dir*/']
        train_outputs = ['/*address to outputs.txt file in multlilingual model output dir*/']
