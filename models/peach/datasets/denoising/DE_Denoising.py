...
class DeDenoising(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_inputs = ['/*address to output of de denoising data generation*/']
        train_outputs = ['/*address to the de corpus file*/']
