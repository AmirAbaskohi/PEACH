...
class EnDenoising(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_inputs = ['/*address to output of en denoising data generation*/']
        train_outputs = ['/*address to the en corpus file*/']
