...
class FrDenoising(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_inputs = ['/*address to output of fr denoising data generation*/']
        train_outputs = ['/*address to the fr corpus file*/']
