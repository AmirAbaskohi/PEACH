...
class DeImprove(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        test_inputs = ['/*Address to outputs of word-by-word translation with the name de.txt*/']
        test_outputs = ['/*Address to outputs of word-by-word translation with the name input.txt corresponding to de.txt*/']
        test_lang_tokens = ['/*<mk><de> or <fr><de> or <en><de> based on the input language of word-by-word tranlation de.txt output */']
