...
class EnImprove(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        test_inputs = ['/*Address to outputs of word-by-word translation with the name en.txt*/']
        test_outputs = ['/*Address to outputs of word-by-word translation with the name input.txt corresponding to en.txt*/']
        test_lang_tokens = ['/*<mk><en> or <fr><en> or <de><en> based on the input language of word-by-word tranlation en.txt output */']
